...
//		// pc.setModuleName(rb.getString("className")+"Entity");//模块名称，单独生成模块时使用！！！！！！！！！！！
...
////				// /maoming-web/src/main/webapp/iframe
////				return "E:\\software\\Eclipse\\workspace\\maoming\\maoming-web\\src\\main\\webapp\\iframe\\"
////						+ tableInfo.getEntityName() + "\\" + tableInfo.getEntityName() + "_list.jsp";
////			}
////		});
...
//				return rb.getString("OutputDirXml") + "/mapper/" + tableInfo.getEntityName() + ".xml";
//			}
//
//		});
//		cfg.setFileOutConfigList(focList);
